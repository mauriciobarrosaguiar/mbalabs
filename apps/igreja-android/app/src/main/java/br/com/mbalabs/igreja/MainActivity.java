...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " ElshadayAndroid/" + BuildConfig.VERSION_NAME);

        webView.setOverScrollMode(View.OVER_SCROLL_NEVER);
        webView.setBackgroundColor(0xFFF3F6F1);
    ...
    private void checkForUpdate() {
        new Thread(() -> {
            ...
            try {
                ...
                conn.setRequestProperty("User-Agent", "ElshadayAndroid/" + BuildConfig.VERSION_NAME);
                ...
                int latestCode = extractInt(body, "versionCode", BuildConfig.VERSION_CODE);
                ...
                // Se a checagem falhar, o app continua funcionando normalmente.
            } finally {
