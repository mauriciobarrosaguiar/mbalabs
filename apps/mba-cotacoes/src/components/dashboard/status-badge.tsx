...
import { quotationStatusLabels, statusLabels } from "@/lib/labels";
...
const statusMap: Record<string, { label: string; className: string }> = {
  ...
  paid: { label: statusLabels.paid, className: "bg-emerald-50 text-emerald-700" },
  ...
  partial: { label: statusLabels.partial, className: "bg-amber-50 text-amber-700" },
  ...
  finalizado_pelo_vendedor: { label: statusLabels.finalizado_pelo_vendedor, className: "bg-emerald-50 text-emerald-700" },
  parcialmente_faturado: { label: statusLabels.parcialmente_faturado, className: "bg-amber-50 text-amber-700" },
  nao_faturado: { label: statusLabels.nao_faturado, className: "bg-red-50 text-red-700" },
  falta_parcial: { label: statusLabels.falta_parcial, className: "bg-amber-50 text-amber-700" },
