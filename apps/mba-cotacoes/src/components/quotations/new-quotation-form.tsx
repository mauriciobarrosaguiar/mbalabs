...
import { JudgmentTypeSelect } from "@/components/forms/judgment-type-select";
import { ProductTypeSelect } from "@/components/forms/product-type-select";
import { UnitSelect } from "@/components/forms/unit-select";
import { YesNoSwitch } from "@/components/forms/yes-no-switch";
...
import { saveDemoQuotationToLocalStorage } from "@/lib/data/demo-repository";
import { formatDateBR, formatInteger } from "@/lib/formatters";
import type { Laboratory, ModuleType, Product, Supplier } from "@/lib/types";
