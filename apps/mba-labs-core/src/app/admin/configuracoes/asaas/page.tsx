        ...
        <section className="page-shell grid gap-6 py-5 sm:py-8">
          <div className="[&_h1]:text-3xl sm:[&_h1]:text-4xl">
            <PageHeader
              ...
              description="Integração central de pagamentos do MBA Labs. Nenhuma configuração desta tela altera regras internas dos apps."
          ...
          <div className="grid gap-4 xl:grid-cols-2">
            <div className="panel grid gap-3 p-5">
              <h2 className="text-lg font-black">Status da integração</h2>
              <p className="text-sm leading-6 text-slate-300">Ambiente: <strong className="text-slate-100">{settings.environment}</strong></p>
              <p className="text-sm leading-6 text-slate-300">API URL: <strong className="break-all text-slate-100">{settings.apiUrl}</strong></p>
            ...
            <div className="panel grid gap-3 p-5">
              <h2 className="text-lg font-black">Webhook do Asaas</h2>
              <p className="text-sm leading-6 text-slate-300">Cadastre esta URL no painel do Asaas para baixa automática.</p>
              <code className="break-all rounded-xl border border-white/10 bg-black/20 p-3 text-sm text-emerald-100">{webhookUrl}</code>
