        ...
        <section className="page-shell grid gap-6 py-5 sm:py-8">
          <div className="[&_h1]:text-3xl sm:[&_h1]:text-4xl">
            <PageHeader
              eyebrow="Financeiro"
              title="Pagamentos"
              description="Cobranças centralizadas do MBA Labs. Gere links Asaas e acompanhe a baixa automática via webhook."
              actions={
          ...
          <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-4 text-sm leading-6 text-slate-400">
            <strong className="text-slate-200">Importante:</strong> o link Asaas com forma de pagamento indefinida permite o cliente escolher os meios habilitados na sua conta Asaas, como Pix, cartão de crédito e boleto. Se o webhook falhar, use o botão Sincronizar Asaas.
          </div>
        </section>
      </div>
    </main>
