        ...
        <section className="page-shell grid gap-6 py-5 sm:py-8">
          <div className="[&_h1]:text-3xl sm:[&_h1]:text-4xl">
            <PageHeader
              ...
              description="Edite apenas o conteúdo público do MBA Labs: marca, textos, WhatsApp, cards, benefícios e rodapé."
          ...
          <form action={saveSiteConfig} className="grid gap-5">
            ...
            <section className="panel grid gap-5 p-5">
              ...
              <div className="grid gap-4 lg:grid-cols-2 xl:grid-cols-3">
                {config.systems.map((system) => (
                  <div className="grid gap-4 rounded-xl border border-white/8 bg-white/[0.025] p-4" key={system.key}>
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-[0.14em] text-slate-500">{system.href}</p>
                      <h2 className="mt-1 text-base font-black">{system.name}</h2>
                    </div>
