...
export function DroneOperationalProfile(){
  ...
  return <main className="min-h-screen bg-[#f4f8f1] px-4 py-5 text-[#143d31] sm:px-6 sm:py-8"><div className="mx-auto grid w-full max-w-3xl gap-4">
    <header className="flex flex-wrap items-center gap-3"><Link href="/apps/dronegestor" aria-label="Voltar" className="grid size-11 place-items-center rounded-2xl border border-[#d9e5dc] bg-white text-[#315d4d]"><ArrowLeft size={20}/></Link><div className="min-w-0 flex-1"><p className="text-xs font-black uppercase tracking-[.16em] text-[#087a55]">Dados do DroneGestor</p><h1 className="text-2xl font-black">Perfil operacional</h1><p className="mt-1 text-sm text-[#718078]">Cadastre uma vez e reutilize nos relatórios e conferências.</p></div><Link href="/apps/dronegestor/equipe" className="min-h-10 rounded-xl border border-[#cfe0d5] bg-white px-3 py-2 text-sm font-black text-[#176a4c] no-underline">Pilotos / equipe</Link></header>
