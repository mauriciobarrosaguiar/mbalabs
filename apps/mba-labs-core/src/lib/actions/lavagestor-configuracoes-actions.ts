...
export async function saveLavaConfiguracoesEmpresa(formData: FormData) {
  ...
  const payload = {
    ...
    exigir_foto_entrada: booleanValue(formData, "exigir_foto_entrada"),
    fotos_entrada_obrigatorias: listValue(formData, "fotos_entrada_obrigatorias"),
    permitir_concluir_checklist_sem_foto: booleanValue(formData, "permitir_concluir_checklist_sem_foto"),
    exigir_foto_checkout_antes_entrega: booleanValue(formData, "exigir_foto_checkout_antes_entrega"),
    permitir_recibo_sem_checklist: booleanValue(formData, "permitir_recibo_sem_checklist"),
    horario_abertura: textValue(formData, "horario_abertura") || "08:00",
    horario_fechamento: textValue(formData, "horario_fechamento") || "18:00",
    intervalo_agenda_min: numberValue(formData, "intervalo_agenda_min", 30),
    ...
    mensagem_confirmacao_agendamento: nullableTextValue(formData, "mensagem_confirmacao_agendamento"),
