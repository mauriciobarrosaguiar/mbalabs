...
import { formatCurrencyBRL, formatPercentBR } from "@/modules/cotacoes/lib/formatters";
import type { PharmacyAnalysisResult } from "@/modules/cotacoes/lib/services/pharmacy-analysis";
