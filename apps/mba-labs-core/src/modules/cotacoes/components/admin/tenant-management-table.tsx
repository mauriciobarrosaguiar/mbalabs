...
import { CustomerTypeSelect } from "@/modules/cotacoes/components/forms/customer-type-select";
import { StatusSelect } from "@/modules/cotacoes/components/forms/status-select";
...
import {
  ...
  DialogHeader,
  DialogTitle,
} from "@/modules/cotacoes/components/ui/dialog";
...
import { formatCurrencyBRL, formatDateBR, parseCurrencyInput } from "@/modules/cotacoes/lib/formatters";
import type { SubscriptionPlan, Tenant } from "@/modules/cotacoes/lib/types";
  ...
  async function save(formData: FormData) {
    ...
    if (remoteTenantCrudEnabled()) {
      try {
        ...
        const response = await fetch("/api/cotacoes/crud/tenants", {
