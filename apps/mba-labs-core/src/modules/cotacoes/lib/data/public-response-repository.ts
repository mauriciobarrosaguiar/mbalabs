...
import { calculateBiddingResponseItem } from "@/modules/cotacoes/lib/services/bidding-analysis";
import {
  calculateSellerRow,
  parseNumberInput,
...
import { isQuotationClosed, isQuotationDeleted } from "@/modules/cotacoes/lib/quotation-status";
import type {
  ModuleType,
  Pharmacy,
  ProductType,
