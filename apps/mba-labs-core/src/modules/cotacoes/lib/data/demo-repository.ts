import { getSupabaseClientMode } from "@/modules/cotacoes/lib/supabase/env";
import { formatCurrency, formatInteger } from "@/modules/cotacoes/lib/formatters";
import { buildBiddingAnalysis, generateBiddingAwards as calculateBiddingAwards } from "@/modules/cotacoes/lib/services/bidding-analysis";
...
import { isQuotationDeleted, isQuotationInProgress, markQuotationGeneratedStatus } from "@/modules/cotacoes/lib/quotation-status";
import type {
  DashboardMetric,
  Distributor,
  Laboratory,
